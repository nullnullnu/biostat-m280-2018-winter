...
```{r}
payroll <-read.csv(file = "/home/m280-data/la_payroll/LA_City_Employee_Payroll.csv", header = TRUE)
head(payroll)
if(!"rio" %in% rownames(installed.packages()))
        install.packages("rio", repos = "http://cran.rstudio.com/")
library("rio")
export(payroll, "LA_City_Employee_Payroll.rds" )
convert("/home/m280-data/la_payroll/LA_City_Employee_Payroll.csv","LA_City_Employee_Payroll.rds")
```
